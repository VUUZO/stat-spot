...
export const metadata: Metadata = {
  title: 'Listento',
  description: 'Listento | Track your Spotify data',
  keywords: [
    "Spotify",
    "Spotify stats",
    "Statistics",
  ...
  return (
    ...
    >
      <body>
          ...
          <img className='-z-10 pointer-events-none select-none w-full lg:w-1/3 fixed top-0 left-0' src="/images/blob001.png" alt="blob" />
          <img className='-z-10 pointer-events-none select-none w-full lg:w-1/2 fixed bottom-0 right-0' src="/images/blob002.png" alt="blob" />
